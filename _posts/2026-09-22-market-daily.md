...
>
> **파이프라인 결함 하나를 밝혀둡니다.** 개별 종목 다섯 개의 방향 블록에 부호(`up`/`down`)는 있는데 설명 문구가 비어 있습니다. "움직이지 않았다"는 뜻이 아니라 값이 빠진 버그입니다. 그래서 종목 섹션은 문구 대신 부호와 수익률을 직접 읽었습니다. 지수·금리·환율 블록은 정상입니다.
